<!--footer start-->
    <footer class="site-footer">
      <div class="text-center">
        <p>
          &copy; Copyrights <strong><?php echo $fun->getAppName(); ?></strong>. 
        </p>
        <div class="credits">
          All Rights Reserved
        </div>
  ...
  <script type="../assets/text/javascript" src="lib/gritter/js/jquery.gritter.js"></script>
  <script type="../assets/text/javascript" src="lib/gritter-conf.js"></script>
